...
@section('actions')
    ...
    @endif
    <a href="{{ rtrim($settings['website'] ?? config('app.url'), '/') }}" class="btn btn-outline" style="display: inline-block; padding: 10px 24px; border-radius: 24px; font-size: 14px; font-weight: 500; text-decoration: none; margin: 4px; border: 1px solid #dadce0; color: #5f6368;">Ver reservación</a>
@endsection
